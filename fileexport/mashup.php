...
function getAllUser($con) {
    $output = "";
    $count = 0;
    $query = "SELECT id, names , origins ,identifications, regions, line_id, whatsapp_no,payment_proof FROM `competition_registrations` WHERE competition_id = 1";
...
<?php include "navbar.php"; ?>
    <div class="container">	
       <div class="row justify-content-md-center">
          <div class="col-4">	
             <br><br><br>
             <h1 style="text-align: center;color: white; font-size: 50px">Mashup</h1>
         </div>
     </div>
 </div>	
